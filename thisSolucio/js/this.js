...
sayHello.call(person1, 'Hello');  //Nombre funcion.call(contexto_a_cojer, parametros_funcion)
sayHello.apply(person1, ['Hi']);  //Nombre funcion.apply(contexto_a_cojer, [parametros_funcion])
// Salida:
// Hello, Dana
// Hi, Dana
...
// Ejercicio 7: Usa `this` dentro de un letructor para asignar propiedades.
